...
MANIFEST_URL = (
    f"https://raw.githubusercontent.com/rezvanf/aws-sam-cli-app-templates/{APP_TEMPLATES_REPO_COMMIT}/manifest-v2.json"
)
APP_TEMPLATES_REPO_URL = "https://github.com/rezvanf/aws-sam-cli-app-templates"
